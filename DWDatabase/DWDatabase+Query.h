...
-(DWDatabaseResult *)handleQueryResultWithClass:(nullable Class)cls dbName:(NSString *)dbName tblName:(NSString *)tblName resultSet:(FMResultSet *)set validProInfos:(nullable NSDictionary<NSString *,DWPrefix_YYClassPropertyInfo *> *)validProInfos mainKeyWrappers:(nullable DWDatabaseBindKeyWrapperContainer)mainKeyWrappers subKeyWrappers:(nullable DWDatabaseBindKeyWrapperContainer)subKeyWrappers databaseMap:(nullable NSDictionary *)databaseMap resultArr:(NSMutableArray *)resultArr queryChains:(nullable DWDatabaseOperationChain *)queryChains recursive:(BOOL)recursive inlineTblNameMap:(nullable NSDictionary *)inlineTblNameMap stop:(BOOL *)stop returnNil:(BOOL *)returnNil stopOnValidValue:(BOOL)stopOnValidValue reprocessing:(nullable DWDatabaseReprocessingHandler)reprocessing;

-(DWDatabaseResult *)handleQueryRecursiveResultWithDbName:(NSString *)dbName tblName:(NSString *)tblName resultArr:(nullable NSMutableArray *)resultArr queryChains:(nullable DWDatabaseOperationChain *)queryChains recursive:(BOOL)recursive subKeyWrappers:(nullable DWDatabaseBindKeyWrapperContainer)subKeyWrappers;
@end
